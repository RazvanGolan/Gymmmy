  ...
  const renderExercise = ({ item, index }: { item: TemplateExercise; index: number }) => (
    <View className="bg-gray-800 rounded-lg p-4 mb-3 shadow-sm">
      <View className="flex-row justify-between items-center mb-3">
        <Text className="text-lg font-semibold text-gray-100 flex-1">
          {item.name}
        </Text>
        <TouchableOpacity
      ...
      <ScrollView className="flex-1">
        ...
        <View className="bg-gray-800 p-4 border-b border-gray-700">
          ...
          <View className="space-y-4">
            <View>
              <Text className="text-sm text-gray-300 mb-1">Template Name *</Text>
              <TextInput
                value={templateName}
            ...
            <View className="flex-row space-x-3">
              <View className="flex-1">
                <Text className="text-sm text-gray-300 mb-1">Category</Text>
                <TextInput
              ...
              <View className="flex-1">
                <Text className="text-sm text-gray-300 mb-1">Est. Duration (min)</Text>
                <TextInput
